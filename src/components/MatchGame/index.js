...
class MatchGame extends Component {
  ...
  componentDidMount() {
    this.timerId = setInterval(this.timerLimit, 1000)
  }
  ...
  stateChange = () => {
    ...
    this.setState({score: 0, timerLimit: 60, showedImage: imagesList[0]})
  ...
  winOrLoosCard = () => {
    ...
    return <WinLose score={score} againGame={this.stateChange} />
  }
  ...
  render() {
    const {isGameStarted, score, timerLimit} = this.state
    return (
